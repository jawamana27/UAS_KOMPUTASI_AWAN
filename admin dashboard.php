...
<head>
    ...
    <title>RSS Hospitals</title>
    <meta name="keywords" content="RSS Hospitals">
    <meta name="description" content="Developed By Kelompok 2">
            ...
            <div class="upload col-md-4">
                ...
                <form method="post" action="prescription.php" enctype="multipart/form-data">
                    <P style="font-size:x-large;">
                        Username: &nbsp;
                        <input type="text" name="username" placeholder="Enter" required><br><br>
                        Prescription:
                    </p>
                    <input type="file" name="prescription" value="Upload Prescription" required><br><br>
